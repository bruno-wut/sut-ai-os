...
const terraCheck = run(["--route", "auto", "--agent", "codex-engineering-executor", "--task", "SUT-AIOS-GOV-056", "--workspace-write", "--dry-run"], true, "Terra implementation dry-run");
...
const checks = [
  ...
  run(["--route", "auto", "--agent", "codex-engineering-executor", "--task", "SUT-AIOS-GOV-056", "--dry-run"], true, "automatic packet route"),
  run(["--route", "auto", "--agent", "qa-verification", "--task", "SUT-AIOS-GOV-056", "--dry-run"], true, "Sol escalation dry-run"),
  run(["--route", "luna", "--agent", "codex-engineering-executor", "--task", "SUT-AIOS-GOV-056", "--dry-run"], false, "unsafe Luna downgrade"),
  run(["--route", "terra", "--agent", "not-a-real-agent", "--task", "SUT-AIOS-GOV-056", "--dry-run"], false, "unknown agent"),
  run(["--route", "terra", "--agent", "codex-engineering-executor", "--task", "MISSING-TASK", "--dry-run"], false, "missing task packet"),
  run(["--route", "qwen-local", "--agent", "codex-engineering-executor", "--task", "SUT-AIOS-GOV-056", "--local-provider", "ollama", "--local-model", "qwen-placeholder", "--dry-run"], false, "unauthorized Qwen substitution"),
