# Task context — SUT-AIOS-GOV-001

Generated: 2026-07-26T12:04:03.369Z
...
- Task: **SUT-AIOS-GOV-001** (active).
- Owner: unknown; reviewer: unknown.
- Business objective: not available in legacy packet
- Technical objective: not available in legacy packet
- Allowed paths: not declared
- Forbidden paths: not declared
- Required tests: not declared
