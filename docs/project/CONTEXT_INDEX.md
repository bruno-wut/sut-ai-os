...
| Context packing or role handoff | [CONTEXT_MANAGEMENT.md](CONTEXT_MANAGEMENT.md) -> active task context -> handoff template -> artifact index |
| Local Qwen preprocessing | [QWEN_SETUP.md](../model-routing/QWEN_SETUP.md) -> [QWEN_ALLOWED_TASKS.md](../model-routing/QWEN_ALLOWED_TASKS.md) -> task packet -> independent verification |
