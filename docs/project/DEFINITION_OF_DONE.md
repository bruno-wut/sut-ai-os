...
3. An independent reviewer verifies scope, diff, prohibited-path compliance, and evidence; V2 review results are structured and SHA-bound; the implementer is not the sole completion authority.
